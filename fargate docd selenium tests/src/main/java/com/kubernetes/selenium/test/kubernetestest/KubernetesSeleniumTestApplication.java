...
public class KubernetesSeleniumTestApplication {
    ...
    static String Geckodriver = "C:/Users/juann/Desktop/serverless/apps microservicios serverless/microservice-kubernetes-fargate-persistence/fargate docd selenium tests/driver/geckodriver.exe";
    static String PathFirefox = "C:\\Program Files\\Firefox Developer Edition\\firefox.exe";
    static WebDriver driver = getDriver(PathFirefox, Geckodriver);
    static String URL = "http://landingpage-microservices-app.s3-website-us-east-1.amazonaws.com/";
    ...
    public void PR02() {
        ...
        result.get(0).click();
        PO_CreateItemView.fillForm(driver,"aa", "test", "10.0");
    ...
    public void PR04() {
        ...
        result.get(0).click();
        PO_CreateCustomerView.fillForm(driver, "aa", "test", "test",
