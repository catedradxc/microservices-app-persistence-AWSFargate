...
public class CatalogClient {
	...
	@Autowired
	public CatalogClient(@Value("${catalog.service.host:3.74.216.46}") String catalogServiceHost,
	...
	private String catalogURL() {
		String url = String.format("http://%s:%s", catalogServiceHost, catalogServicePort);
